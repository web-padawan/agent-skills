...
3. **Never fix by weakening a test.** If a `direction` finding says a test pins wrong behavior, fix the behavior, or fix the expectation to match the stated intent — never relax the assertion to make it pass.
